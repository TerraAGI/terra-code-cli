...
vi.mock('@terra-code/terra-code-core', async () => {
  const actual = await vi.importActual('@terra-code/terra-code-core');
  return {
    ...actual,
    uiTelemetryService: {
...
import { GeminiClient, uiTelemetryService } from '@terra-code/terra-code-core';
